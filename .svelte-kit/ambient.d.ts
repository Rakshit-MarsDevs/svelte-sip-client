...
declare module '$env/static/private' {
	export const VITE_SIP_SERVER: string;
	export const VITE_SIP_USERNAME: string;
	export const VITE_SIP_PASSWORD: string;
	export const VITE_WEBSOCKET_SERVER: string;
